...
class LinesDealScheduling {
    ...
    public:
        ...
        vector<Stripe> repairboost(map<int, int>&, int, int, int*, int*, int*);
        // vector<Stripe> random_select(int, int, int, int*, int*, int*);
        // vector<Stripe> least_recent_selected(int, int, int, int*, int*, int*);
        vector<Stripe> random_select(map<int, int>&, int, int, int*, int*, int*);
        vector<Stripe> least_recent_selected(map<int, int>&, int, int, int*, int*, int*);
        ...
        void unitTestForMapping(vector<Stripe>&, int*, int*, map<int, int>&, int);
        void unitTestForSchedulingScheme(vector<Stripe>&, int, int, vector<vector<pii> >&, vector<vector<pii> >&);
