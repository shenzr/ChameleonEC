...
for slave in slavelist:
    os.system("scp " + bandwidth_dir + "/BandWidthMonitor.py " + slave + ":" + bandwidth_dir + "/")
    
    command = "ssh " + slave + " \" python3 " + bandwidth_dir + "/BandWidthMonitor.py " + home_dir+ "/logs/bd-output.csv " + str(periodLen) + " &> "+ home_dir + "/logs/run-BD-Monitor-log &\" "
    print(command)
