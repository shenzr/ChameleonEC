...
for slave in slavelist:
    # os.system("ssh " + slave + " \" sudo apt-get install cgroup-tools\"")
    command = "ssh " + slave + " \" cd /sys/fs/cgroup/net_cls && mkdir elastic-repair && echo 0x00010100 > elastic-repair/net_cls.classid \" " 
    print(command)
    os.system(command)
